...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
	public interface INotepadPPGateway
	{
        ...
        string GetFilePathFromBufferId(IntPtr bufferId);
	...
	public class NotepadPPGateway : INotepadPPGateway
	{
        ...
        /// <summary>
        /// Gets the path of the current document from BufferId.
        /// </summary>
        public string GetFilePathFromBufferId(IntPtr bufferId)
        {
            var path = new StringBuilder(2000);
            Win32.SendMessage(PluginBase.nppData._nppHandle, (uint)NppMsg.NPPM_GETFULLPATHFROMBUFFERID, bufferId, path);
            return path.ToString();
