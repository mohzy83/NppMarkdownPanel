...
function makeReleaseZip($filename, $targetPlattform)
{
	...
	Compress-Archive -LiteralPath $filename, 'Release\lib\', 'License.txt', "NppMarkdownPanel\style.css" , "NppMarkdownPanel\style-dark.css" -DestinationPath $zipName -Force
}
